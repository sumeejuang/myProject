						...
						<tbody>
							...
							<tr>
								<td class="hidden-xs"><a href="#"><img
										src="assets/images/shop/product-14.jpg" alt="Accessories Pack"></a></td>
								<td>
								...
								<td class="pr-remove"><a href="#" title="Remove"><i
										class="fa fa-times text-dark"></i></a></td>
							</tr>
							<tr>
								<td class="hidden-xs"><a href="#"><img
			...
			<div class="row mt-70">
				<div class="col-sm-5 col-sm-offset-7">
					<div class="shop-Cart-totalbox">
						...
						<button class="btn btn-lg btn-block btn-round btn-d" type="submit">Proceed
							to Checkout</button>
					</div>
				</div>
			</div>
