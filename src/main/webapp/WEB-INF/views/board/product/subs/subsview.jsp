            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="row mb-20">
                  ...
                  <span><i class="fa fa-star star"></i></span><span>
                  <i class="fa fa-star star"></i></span><span><i class="fa fa-star star"></i></span>
            ...
            <div class="row mt-70">
              <div class="col-sm-12">
                <ul class="nav nav-tabs font-alt" role="tablist">
                  <li class="active"><a href="#description" data-toggle="tab" aria-expanded="true"><span class="icon-tools-2"></span>Description</a></li>
                  <li class=""><a href="#data-sheet" data-toggle="tab" aria-expanded="false"><span class="icon-tools-2"></span>Data sheet</a></li>
                  <li class=""><a href="#reviews" data-toggle="tab" aria-expanded="false"><span class="icon-tools-2"></span>Reviews (2)</a></li>
                </ul>
