                ...
                <div class="comments">
                  ...
                  <div class="comment clearfix">
                    ...
                    <div class="comment-content clearfix">
                      <div class="comment-author font-alt"><a class="text-dark" href="#">John Doe</a></div>
                      ...
                      <div class="comment-meta font-alt">Today, 14:55 - <a class="text-dark" href="#">Reply</a>
                      </div>
                    </div>
                    <div class="comment clearfix">
                      <div class="comment-avatar"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/draganbabic/128.jpg" alt="avatar"></div>
                      <div class="comment-content clearfix">
                        <div class="comment-author font-alt"><a class="text-dark" href="#">Mark Stone</a></div>
                        <div class="comment-body">
                        ...
                        <div class="comment-meta font-alt">Today, 15:34 - <a class="text-dark" href="#">Reply</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="comment clearfix">
                    ...
                    <div class="comment-content clearfix">
                      <div class="comment-author font-alt"><a class="text-dark" href="#">Andy</a></div>
                      <div class="comment-body">
                        <p>The European languages are members of the same family. Their separate existence is a myth. For science, music, sport, etc, Europe uses the same vocabulary. The European languages are members of the same family. Their separate existence is a myth.</p>
                      </div>
                      <div class="comment-meta font-alt">Today, 14:59 - <a class="text-dark" href="#">Reply</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-4 col-md-3 col-md-offset-1 sidebar">
                ...
                <div class="widget">
                  ...
                  <ul class="widget-posts">
                    <li class="clearfix">
                      <div class="widget-posts-image"><a class="text-dark" href="#"><img src="assets/images/rp-1.jpg" alt="Post Thumbnail"></a></div>
                    ...
                    <li class="clearfix">
                      <div class="widget-posts-image"><a class="text-dark" href="#"><img src="assets/images/rp-2.jpg" alt="Post Thumbnail"></a></div>
                      <div class="widget-posts-body">
                    ...
                    <li class="clearfix">
                      ...
                      <div class="widget-posts-body">
                        <div class="widget-posts-title"><a class="text-dark" href="#">Eco bag Mockup</a></div>
                    ...
                    <li class="clearfix">
                      ...
                      <div class="widget-posts-body">
                        <div class="widget-posts-title"><a class="text-dark" href="#">Bottle Mockup</a></div>
