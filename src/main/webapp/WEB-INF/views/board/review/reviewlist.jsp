...
<div class="main">
	<section class="module home-full-weight bg-light">
		<div class="container">
			<h3 class="font-alt">Reviews</h3>
			<h5 class="font-alt">| 회원님들의 소중한 ${count }개의 리뷰후기</h5>
					...
					<div class="card-body">
						...
						<div class="row mb-20">
							<div class="col-sm-12">
								...
								<span> Rating ${rboard.reviewStar }, </span> <span> By
									${rboard.reviewWriter },</span> <span> <i class="fa fa-clock-o"
									aria-hidden="true"></i> ${rboard.reviewRegdate }
								</span>
							</div>
						</div>
						<p class="card-text">${rboard.reviewContent }</p>
						<c:if
							test="${principal.user.username==rboard.reviewWriter||principal.user.userrole =='ROLE_ADMIN' }">
			...
			<ul class="pagination font-alt">
				<c:if test="${lists.first==false}">
					<li class="page-item"><a class="page-link text-dark"
						href="?page=${lists.number-1 }"> <i class="fa fa-angle-left"></i>&nbsp;Previous
					</a></li>
				</c:if>
